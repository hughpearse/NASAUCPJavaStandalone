/*  
                           ...
                           A Java Applet
               to wind tunnel test a  Kutta-Joukowski Airfoil 
                      receives input from the design applet
                      then post-process the results
                          Derived from FoilSim II
                   Derived from 3 TunnelDys applications
           This applet is used to "advertise" for the applications

                       Version 1.0a   - 15 July 09
...
public class Wys extends java.applet.Applet {
  ...
  public void computeFlow() { 
     ...
     solvew.getCirc ();                   /* get circulation */
     solvew.getGeom ();                   /* get geometry*/
     solvew.genFlow () ;
  ...
  public void loadInput() {   // load the input panels
       ...
       if (lunits == 1) outarea = " m^2" ;
                  ...
                  //  dimensional
       if (lunits == 0) {
           inw.flt.upr.inl.l1.setText("Speed-mph") ;
           inw.flt.upr.inl.l2.setText("Pressure-psf") ;
   //        inw.flt.upr.inl.l4.setText("Temperature - R") ;
           inw.cyl.inl.l2.setText("Radius ft") ;
           inw.cyl.inl.l3.setText("Span ft") ;
       }
       if (lunits == 1) {
           inw.flt.upr.inl.l1.setText("Speed-km/h") ;
           inw.flt.upr.inl.l2.setText("Pressure-kPa") ;
  //         inw.flt.upr.inl.l4.setText("Temperature - K") ;
           inw.cyl.inl.l2.setText("Radius m") ;
           inw.cyl.inl.l3.setText("Span m") ;
       }
       v4 = vfsd ;
       vmn = 0.0;   vmx= vmax ;
       v5 = psin ;
       ...
       inw.flt.upr.inl.f1.setText(String.valueOf(fl4)) ;
       inw.flt.upr.inl.f2.setText(String.valueOf(fl5)) ;
       inw.cyl.inl.f2.setText(String.valueOf(fl6)) ;
   
       i4 = (int) (((v4 - vmn)/(vmx-vmn))*1000.) ;
       i5 = (int) (((v5 - psmn)/(psmx-psmn))*1000.) ;
       i6 = (int) (((v6 - radmn)/(radmx-radmn))*1000.) ;

       inw.flt.upr.inr.s1.setValue(i4) ;
       inw.flt.upr.inr.s2.setValue(i5) ;
       inw.cyl.inr.s2.setValue(i6) ;
/*
       v5 = tsin ;
       tsmn = tsmin*ticonv ;  tsmx = tsmax*ticonv ;
       fl5 = filter0(v5) ;
       inw.flt.upr.inl.f4.setText(String.valueOf(fl5)) ;
       i5 = (int) (((v5 - tsmn)/(tsmx-tsmn))*1000.) ;
       inw.flt.upr.inr.s4.setValue(i5) ;
*/
       ...
       inw.flt.upr.inl.f3.setText(String.valueOf(fl3)) ;
       inw.cyl.inl.f1.setText(String.valueOf(fl4)) ;

       i3 = (int) (((v3 - angmn)/(angmx-angmn))*1000.) ;
       i4 = (int) (((v4 - spinmn)/(spinmx-spinmn))*1000.) ;
     
       inw.flt.upr.inr.s3.setValue(i3) ;
       inw.cyl.inr.s1.setValue(i4) ;

       conw.dwn.o2.setText(String.valueOf(filter3(camval * 25.0)) ) ;
       conw.dwn.o4.setText(String.valueOf(filter3(thkval * 25.0)) ) ;
       conw.dwn.o5.setText(String.valueOf(filter3(aspr)) ) ;
       conw.dwn.o1.setText(String.valueOf(filter3(chord)) + outlngth) ;
       conw.dwn.o3.setText(String.valueOf(filter3(span)) + outlngth) ;
       conw.dwn.o6.setText(String.valueOf(filter3(area)) + outarea) ;
...
//        conw.dwn.o4.setText(String.valueOf(filter3(clift))) ;
        ...
        if (lftout == 0) {
          ...
          if (Math.abs(lift) <= 10.0) {
             conw.dwn.o10.setText(String.valueOf(filter3(lift)) + outfor) ;
          }
          if (Math.abs(lift) > 10.0) {
             conw.dwn.o10.setText(String.valueOf(filter0(lift)) + outfor) ;
          }
        }
     }
     ...
     switch (lunits)  {
       case 0: {                             /* English */
           conw.dwn.o9.setText(String.valueOf(filter5(rho))+outden) ;
           conw.dwn.o7.setText(String.valueOf(filter3(q0)) + outpres) ;
           conw.dwn.o8.setText(String.valueOf(filter3(pt0)) + outpres) ;
           break;
        }
        case 1: {                             /* Metric */
           conw.dwn.o9.setText(String.valueOf(filter3(rho*515.4))+outden) ;
           conw.dwn.o7.setText(String.valueOf(filter3(q0*.04787)) + outpres) ;
           conw.dwn.o8.setText(String.valueOf(filter3(pt0*.04787)) + outpres) ;
           break ;
        }
     }
...
//             add("North",bt4) ;
           ...
           class L2 extends Canvas  {
              ...
              public void paint(Graphics g) {
                ...
                off5Gg.setColor(Color.black) ;
                off5Gg.fillRect(0,0,250,150) ;

                if (pboflag == 0 || pboflag == 3)off5Gg.setColor(Color.gray);
                if (pboflag == 1 || pboflag == 2)off5Gg.setColor(Color.yellow) ;
                off5Gg.fillArc(40,30,80,80,-23,227) ;
                off5Gg.setColor(Color.black) ;
         // tick marks
                for (index = 1; index <= 4; ++ index) {
                    ex = 80 + (int) (50.0 * Math.cos(convdr * (-22.5 + 45.0 * index))) ;
                    ey = 50 - (int) (50.0 * Math.sin(convdr * (-22.5 + 45.0 * index))) ;
                    off5Gg.drawLine(60,70,ex,ey) ;
                }
                off5Gg.fillArc(45,35,70,70,-25,235) ;
      
                off5Gg.setColor(Color.yellow) ;
                off5Gg.drawString("0",30,95) ;
                off5Gg.drawString("2",30,55) ;
                off5Gg.drawString("4",55,30) ;
                off5Gg.drawString("6",95,30) ;
                off5Gg.drawString("8",120,55) ;
                off5Gg.drawString("10",120,95) ;

                off5Gg.setColor(Color.green) ;
                if (pboflag == 1) {
                    off5Gg.drawString("Velocity",60,15) ;
                    if (lunits == 0) off5Gg.drawString("mph",70,125) ;
                    if (lunits == 1) off5Gg.drawString("km/h",70,125) ;
                }
                if (pboflag == 2) {
                    off5Gg.drawString("Pressure",50,15) ;
                    if (lunits == 0) off5Gg.drawString("psi",70,125) ;
                    if (lunits == 1) off5Gg.drawString("kPa",70,125) ;
                }

                off5Gg.setColor(Color.green) ;
                off5Gg.drawString("x 10",85,110) ;
                ...
                if (pbval <= .001) {
                   pbout = pbval * 1000. ;
                   off5Gg.drawString("-4",110,105) ;
                }
                if (pbval <= .01 && pbval > .001) {
                   pbout = pbval * 100. ;
                   off5Gg.drawString("-3",110,105) ;
                }
                if (pbval <= .1 && pbval > .01) {
                   pbout = pbval * 10. ;
                   off5Gg.drawString("-2",110,105) ;
                }
                if (pbval <= 1 && pbval > .1) {
                   pbout = pbval * 10. ;
                   off5Gg.drawString("-1",110,105) ;
                }
                if (pbval <= 10 && pbval > 1) {
                   pbout = pbval  ;
                   off5Gg.drawString("0",110,105) ;
                }
                ...
                off5Gg.setColor(Color.green) ;
                off5Gg.drawString(String.valueOf(filter3(pbout)),50,110) ;

                off5Gg.setColor(Color.yellow) ;
                ex = 80 - (int) (30.0 * Math.cos(convdr *
                           (-22.5 + pbout * 225. /10.0))) ;
                ey = 70 - (int) (30.0 * Math.sin(convdr *
                           (-22.5 + pbout * 225. /10.0))) ;
                off5Gg.drawLine(80,70,ex,ey) ;
...
/*
            if(label.equals("Install Model")) {
               ...
               lunits = dlunits[i1] ;
  	       setUnits();
	       if (lunits == 0)  inw.flt.lwr.untch.select(0);
	       if (lunits == 1)  inw.flt.lwr.untch.select(1);
               camval = dcam[i1] ;
               thkval = dthk[i1] ;
               span = dspan[i1] ;
	       chord = dchrd[i1] ;  
...
//                	   inl.f4.setText(String.valueOf(filter0(fl4))) ;
               ...
               i2 = (int) (((2116.217 - psmn)/(psmax-psmn))*1000.) ;
   ...
   //            add(s4);
		...
		endact = new ActionListener()
            ...
            bt5 = new Button("Smoke") ;
            bt5.setBackground(Color.blue) ;
            bt5.setForeground(Color.white) ;

            bt6 = new Button("Particle") ;
...
*/
            ...
            add(new Label("Visualization", Label.LEFT));
            add(new Label("", Label.CENTER));
            add(new Label("", Label.CENTER));
            ...
            add(new Label("", Label.CENTER));
 //           add(bt3) ;
            add(new Label("Units", Label.CENTER));
            add(untch) ;
            add(new Label("", Label.CENTER));
...
*/
		   ...
		   bt6.setForeground(Color.black);
            ...
            if(label.equals("Reset")) {
               inw.flt.upr.inl.bto.setBackground(Color.blue) ;
               inw.flt.upr.inl.bto.setForeground(Color.white) ;
		   ...
		   upr.inl.f3.setEditable(true);
               ...
               solvew.setDefaults() ;
               layin.show(inw, "first")  ;
               untch.select(lunits) ;
                   // **** the lunits check MUST come first
               setUnits () ;
               layplt.show(ouw.grf.l, "first") ;
               layout.show(ouw, "first")  ;
               outopt = 0 ;
    ...
    // Input for computations
           ...
           public void handleCho(Event evt) {
             ...
             if(foiltype <= 2) layin.show(inw, "second")  ;
             if(foiltype == 3) {
                layin.show(inw, "second")  ;
                thkinpt = v2 = thkmn ;
                thkval  = thkinpt / 25.0 ;
             }
             if(foiltype == 4) layin.show(inw, "fourth")  ;
             if(foiltype == 5) {
                 radius = span ;
                 area = 3.1415926*radius*radius ;
                 layin.show(inw, "fourth")  ;
...
*/
               if (x >= 42 && x <= 192) { // pressure plot
                   dispp = 0 ;
                   calcrange = 0 ;
                   computeFlow() ;
               }
               if (x >= 200 && x <= 350) { // velocity plot
                   dispp = 1 ;
                   calcrange = 0 ;
                   computeFlow() ;
               }
...
// *******
        ...
        public void paint(Graphics g) {
           ...
           if (dispp <= 1) {
              ...
              off4Gg.fillRect(0,0,500,500) ;
/*
              off4Gg.setColor(Color.white) ;
              off4Gg.fillRect(2,302,70,15) ;
              off4Gg.setColor(Color.red) ;
              off4Gg.drawString("Rescale",8,315) ;
*/
              off4Gg.setColor(Color.lightGray) ;
              off4Gg.fillRect(0,295,500,50) ;
              off4Gg.setColor(Color.white) ;
              if (dispp == 0) off4Gg.setColor(Color.yellow) ;
              off4Gg.fillRect(42,302,150,20) ;
              off4Gg.setColor(Color.black) ;
              off4Gg.drawString("Surface Pressure",48,317) ;

              off4Gg.setColor(Color.white) ;
              if (dispp == 1) off4Gg.setColor(Color.yellow) ;
              off4Gg.fillRect(200,302,120,20) ;
              off4Gg.setColor(Color.black) ;
              off4Gg.drawString("Velocity",248,317) ;
           }
           if (dispp > 1 && dispp <= 15) {
...
*/
           ...
           if (dispp <= 15) {             /*  draw a graph */
              ...
              off4Gg.drawString(laby,xlabel,ylabel) ;
              off4Gg.drawString(labyu,xlabel,ylabel+10) ;
                                                    /* add tick values */
              for (ind= 1; ind<= ntiky; ++ind){
                   ...
                   if (nord >= 2) {
                      off4Gg.drawString(String.valueOf((int) yl),xlabel,ylabel) ;
                   }
                   else {
                      off4Gg.drawString(String.valueOf(filter3(yl)),xlabel,ylabel);
                   }
              }
              xlabel = (int) (factp*3.0) + xtp ;    /* label x axis */
              ylabel = (int) (40.0) + ytp ;
              off4Gg.drawString(labx,xlabel,ylabel-10) ;
              off4Gg.drawString(labxu,xlabel,ylabel) ;
                                                   /* add tick values */
              for (ind= 1; ind<= ntikx; ++ind){
                   ...
                   if (nabs == 1) {
                      off4Gg.drawString(String.valueOf(xl),xlabel,ylabel) ;
                   }
                   if (nabs > 1) {
                      off4Gg.drawString(String.valueOf((int) xl),xlabel,ylabel) ;
                   }
              }
              ...
              if(lines == 0) {
                 for (i=1; i<=npt; ++i) {
                     ...
                     off4Gg.drawString("*",xlabel,ylabel) ;
                 }
              }
              else {
                if (dispp <= 1) {
//                 if (anflag != 1 || (anflag == 1 && Math.abs(alfval) < 10.0)) {
                   for (j=0; j<=ntr-1; ++j) {
                      k = 2 - j ;
                      if (k == 0) {
                        off4Gg.setColor(Color.magenta) ;
                        xlabel = (int) (factp* 6.1) + xtp ;
                        ylabel = (int) (factp* -2.5) + ytp ;
                        off4Gg.drawString("Upper",xlabel,ylabel) ;
                      }
                      if (k == 1) {
                        off4Gg.setColor(Color.yellow) ;
                        xlabel = (int) (factp* 6.1) + xtp ;
                        ylabel = (int) (factp* -1.5) + ytp ;
                        off4Gg.drawString("Lower",xlabel,ylabel) ;
                      }
                      if (k == 2) {
                        off4Gg.setColor(Color.green) ;
                        xlabel = (int) (factp* 2.0) + xtp ;
                        ylabel = (int) (factp* -5.0) + ytp ;
                        off4Gg.drawString("Free Stream",xlabel,ylabel) ;
                      }
...
*/
               ...
               off4Gg.setColor(Color.red) ;
               off4Gg.fillOval(xlabel,ylabel,5,5) ;
               }
             }
          }
          ...
          if(dispp == 20)  {      /*  draw the lift gauge */
              off4Gg.setColor(Color.black) ;
              off4Gg.fillRect(0,100,300,30) ;
            // Thermometer gage
              off4Gg.setColor(Color.white) ;
              if (lftout == 0) {
                 off4Gg.drawString("Lift =",70,75) ;
                 if (lunits == 0) off4Gg.drawString("Pounds",190,75) ;
                 if (lunits == 1) off4Gg.drawString("Newtons",190,75) ;
              }
              if (lftout == 1) off4Gg.drawString(" Cl  =",70,75) ;
              off4Gg.setColor(Color.yellow);
              for (index=0 ; index <= 10; index ++) {
                off4Gg.drawLine(7+index*25,100,7+index*25,110) ;
                off4Gg.drawString(String.valueOf(index),5+index*25,125) ;
              }
              ...
              if (lftout == 0) {
                 if (Math.abs(lift) <= 1.0) {
                    ...
                    off4Gg.fillRect(0,100,7 + (int) (25*Math.abs(liftab)),10) ;
                    off4Gg.drawString("-1",180,70) ;
                 }
                 if (Math.abs(lift) > 1.0 && Math.abs(lift) <= 10.0) {
                    liftab = lift ;
                    off4Gg.setColor(Color.yellow);
                    off4Gg.fillRect(0,100,7 + (int) (25*Math.abs(liftab)),10) ;
                    off4Gg.drawString("0",180,70) ;
                 }
             ...
             off4Gg.setColor(Color.white);
             off4Gg.drawString(String.valueOf(filter3(liftab)),110,75) ;
             off4Gg.drawString(" X 10 ",150,75) ;
          }
          ...
          if(dispp == 25)  {      /*  draw the generating cylinder */
             ...
             whys[1] = (int) (fact*(0.0)) + yt ;
             off4Gg.drawString("*",exes[1],whys[1]+5) ;
             exes[1] = (int) (fact*(-1.0)) + xt ;
             whys[1] = (int) (fact*(0.0)) + yt ;
             off4Gg.drawString("*",exes[1],whys[1]+5) ;
          }
     ...
     class Perf extends Panel {
        ...
        Perf (Wys target) {
           ...
           prnt.appendText("Wysnel - Wind Tunnel 1.0 beta - 10 Sept 08 ") ;
           add(prnt) ;
        }
     }  // Perf
  } // Ouw 
...
/*
         ...
         conw.dwn.o1.setText(String.valueOf(xt)) ;
...
*/
     ...
     public void handleb(int x, int y) {
         if (y >= 300) { 
            if (x >= 42 && x <= 192) { // transparent wall
               viewflg = 0 ;
            }
            if (x >= 200 && x <= 350) { // solid wall
               viewflg = 2 ;
            }
         }
         view.repaint() ;
     ...
     public void paint(Graphics g) {
        ...
        exes[3] = 0 ;
        whys[3] = 500 ;
        off3Gg.fillPolygon(exes,whys,4) ;
...
*/
                ...
                if (displ == 2 && (i/3*3 == i) ) {
                  off3Gg.setColor(col) ;
                  for (n=1 ; n <= 4 ; ++n) {
                     if(i == 6 + (n-1)*9) off3Gg.setColor(Color.yellow);
                  }
                  if(i/9*9 == i) off3Gg.setColor(Color.white);
                  off3Gg.drawLine(exes[0],whys[0],exes[1],whys[1]) ;
                }
                if (displ == 1 && ((i-antim)/3*3 == (i-antim)) ) {
                  if (ancol == -1) {          /* MODS  27 JUL 99 */
                    if((i-antim)/6*6 == (i-antim))off3Gg.setColor(col);
                    if((i-antim)/6*6 != (i-antim))off3Gg.setColor(Color.white);
                  }
                  if (ancol == 1) {          /* MODS  27 JUL 99 */
                    if((i-antim)/6*6 == (i-antim))off3Gg.setColor(Color.white);
                    if((i-antim)/6*6 != (i-antim))off3Gg.setColor(col);
          ...
          off3Gg.setColor(Color.white) ; /* stagnation */
          ...
          if (pboflag > 0 && pypl <= 0.0) {
             off3Gg.setColor(Color.magenta) ;
             yprs = .1 * pxpl ;
             off3Gg.fillOval((int) (fact*pxpl) + xt,
...
*/
                ...
                if (displ == 2 && (i/3*3 == i) ) {
                  off3Gg.setColor(col);   /* MODS  27 JUL 99 */
                  for (n=1 ; n <= 4 ; ++n) {
                     if(i == 6 + (n-1)*9) off3Gg.setColor(Color.yellow);
                  }
                  if(i/9*9 == i) off3Gg.setColor(Color.white);
...
/*
                if (foiltype <= 3) {
                   ...
                   off3Gg.drawLine(exes[0],whys[0],exes[0]-250,whys[0]) ;
                   off3Gg.drawString("Reference",30,whys[0]+10) ;
                   off3Gg.drawString("Angle",exes[0]+20,whys[0]) ;
      
                   off3Gg.setColor(Color.cyan) ;
                   exes[1] = (int) (fact*(xpl[0][inmax] -
                         4.0*Math.cos(convdr*alfval)))+xt;
                   whys[1] = (int) (fact*(-ypl[0][inmax] -
                         4.0*Math.sin(convdr*alfval)))+yt;
                   off3Gg.drawLine(exes[0],whys[0],exes[1],whys[1]) ;
                   off3Gg.drawString("Chord Line",exes[0]+20,whys[0]+20) ;
   
                   off3Gg.setColor(Color.red) ;
                   off3Gg.drawLine(exes[1],whys[1],camx[5],camy[5]) ;
                   for (i=7 ; i<= npt2-6; i = i+2) {
                      off3Gg.drawLine(camx[i],camy[i],camx[i+1],camy[i+1]) ;
                   }
                   off3Gg.drawString("Mean Camber Line",exes[0]-70,whys[1]-10) ;
                }
                if (foiltype >= 4) {
                   off3Gg.setColor(Color.red) ;
                   ...
                   whys[1] = (int) (fact*(-ypl[0][npt2])) + yt ;
                   off3Gg.drawLine(exes[0],whys[0],exes[1],whys[1]) ;
                   off3Gg.drawString("Diameter",exes[0]+20,whys[0]+20) ;
                }
   
                off3Gg.setColor(Color.green) ;
                off3Gg.drawString("Flow",30,145) ;
                off3Gg.drawLine(30,152,60,152) ;
                exes[0] = 60 ;  exes[1] = 60; exes[2] = 70 ;
                whys[0] = 157 ;  whys[1] = 147 ; whys[2] = 152  ;
                off3Gg.fillPolygon(exes,whys,3) ;
*/
             }
...
/*
                ...
                whys[2] = (int) (fact*(-ypl[0][1])) + yt2 ;
                off3Gg.drawLine(exes[1],whys[1],exes[2],whys[2]) ;
                off3Gg.drawString("Span",exes[2]+10,whys[2]+10) ;
                ...
                whys[2] = whys[1] ;
                off3Gg.drawLine(exes[1],whys[1],exes[2],whys[2]) ;
                if (foiltype <= 3) off3Gg.drawString("Chord",exes[2]+10,whys[2]+15);
                if (foiltype >= 4) off3Gg.drawString("Diameter",exes[2]+10,whys[2]+15);

                off3Gg.drawString("Flow",40,75) ;
                off3Gg.drawLine(30,82,60,82) ;
                exes[0] = 60 ;  exes[1] = 60; exes[2] = 70 ;
...
/*
        off3Gg.setColor(Color.black) ;
        off3Gg.fillRect(0,0,300,30) ;
        off3Gg.setColor(Color.white) ;
        off3Gg.drawString("View:",5,10) ;
        if (viewflg == 0) off3Gg.setColor(Color.yellow) ;
        else off3Gg.setColor(Color.cyan) ;
        off3Gg.drawString("Edge",65,10) ;
        if (viewflg == 1) off3Gg.setColor(Color.yellow) ;
        else off3Gg.setColor(Color.cyan) ;
        off3Gg.drawString("Top",115,10) ;
        if (viewflg == 2) off3Gg.setColor(Color.yellow) ;
        else off3Gg.setColor(Color.cyan) ;
        off3Gg.drawString("Side-3D",150,10) ;
        off3Gg.setColor(Color.red) ;
        off3Gg.drawString("Find",210,10) ;
*/
              ...
              off3Gg.setColor(Color.white) ;
              if (viewflg == 0) off3Gg.setColor(Color.yellow) ;
              off3Gg.fillRect(32,302,160,20) ;
              off3Gg.setColor(Color.black) ;
              off3Gg.drawString("Transparent Surface",40,317) ;

              off3Gg.setColor(Color.white) ;
              if (viewflg == 2) off3Gg.setColor(Color.yellow) ;
              off3Gg.fillRect(200,302,120,20) ;
              off3Gg.setColor(Color.black) ;
              off3Gg.drawString("Solid Surface",228,317) ;
/*
        if (displ == 0) off3Gg.setColor(Color.yellow) ;
        else off3Gg.setColor(Color.cyan) ;
        off3Gg.drawString("Streamlines",55,25) ;
        if (displ == 1) off3Gg.setColor(Color.yellow) ;
        else off3Gg.setColor(Color.cyan) ;
        off3Gg.drawString("Moving",130,25) ;
        if (displ == 2) off3Gg.setColor(Color.yellow) ;
        else off3Gg.setColor(Color.cyan) ;
        off3Gg.drawString("Frozen",180,25) ;
        if (displ == 3) off3Gg.setColor(Color.yellow) ;
        else off3Gg.setColor(Color.cyan) ;
        off3Gg.drawString("Geometry",230,25) ;
        off3Gg.setColor(Color.white) ;
        off3Gg.drawString("Display:",5,25) ;
 // zoom in

        off3Gg.setColor(Color.black) ;
        off3Gg.fillRect(0,30,30,150) ;
        off3Gg.setColor(Color.green) ;
        off3Gg.drawString("Zoom",2,180) ;
        off3Gg.drawLine(15,35,15,165) ;
        off3Gg.fillRect(5,sldloc,20,5) ;
*/
