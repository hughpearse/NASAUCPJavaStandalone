/*
               ...
               to perform Kutta-Joukowski Airfoil analysis
                including drag from wind tunnel tests
                   ...
                   Elementary  Version - limited input
                      controlled by buttons only

                     Version 1.1c   - 3 Sep 10
...
>or services provided hereunder.
  ...
  New Test C
           ...
           *  release as FoilSim III
                                              ...
                                              TJB 27 July 10
  New Test D
           *  make elementary version
           *  put all input on 1 panel .. no change
           *  use gage output ... make vertical
           *  try new idea of  increase - decrease buttons for variables 
                        in place of sliders
...
public class Foil extends java.applet.Applet {
  ...
  public void loadInput() {   // load the input panels
       ...
       String outspd,outalt,outdeg,outlng,outare ;
       ...
       in.elm.inl.f1.setText(String.valueOf(filter0(fl1)) + outlng) ;
       in.elm.inl.f2.setText(String.valueOf(filter0(fl2)) + outlng) ;
       in.elm.inl.f3.setText(String.valueOf(filter0(fl3)) + outdeg) ;
       in.elm.inl.f4.setText(String.valueOf(filter0(fl4)) + outspd) ;
       in.elm.inl.f5.setText(String.valueOf(filter0(fl5)) + outalt) ;
       in.elm.inl.f6.setText(String.valueOf(filter1(fl6)) + outare) ;
...
*/
    ...
    public void getDrag()     //Drag Interpolator
        {
        int index,ifound ;  
  ...
  class Con extends Panel {
     ...
     Con (Foil target) { 
       ...
       add(FSlabel) ;
       add(new Label("Elementary ", Label.RIGHT));
       add(new Label("Version 1.1c", Label.LEFT));
       add(bt3) ;
       ...
       add(new Label("Blue Button ", Label.CENTER));
       add(new Label("DECREASES ", Label.CENTER));
       add(new Label("Input Value ", Label.LEFT));
/*
       add(ibt1);
       add(ibt2);
       add(obt2);
...
*/
       ...
       add(new Label(" ", Label.RIGHT));
       add(new Label("Red Button ", Label.CENTER));
       add(new Label("INCREASES ", Label.CENTER));
       add(new Label("Input Value ", Label.LEFT));
...
//       add(outch) ;
       add(new Label("Lift ", Label.CENTER));
       add(outlft) ;
     ...
     class Elm extends Panel {
        ...
        class Inl extends Panel {
           ...
           Inl (Foil target) {
            ...
            l01 = new Label("Variable", Label.CENTER) ;
            l01.setForeground(Color.blue) ;
            l02 = new Label("Value", Label.CENTER) ;
            l02.setForeground(Color.blue) ;

            l4 = new Label("Speed", Label.CENTER) ;
            f4 = new TextField("100 mph",5) ;

            l5 = new Label("Altitude", Label.CENTER) ;
            f5 = new TextField("0 ft",5) ;

            l6 = new Label("Wing Area", Label.CENTER) ;
            f6 = new TextField("100 sq ft",5) ;

            l1 = new Label("Camber", Label.CENTER) ;
            f1 = new TextField("0 %chrd",5) ;

            l2 = new Label("Thickness", Label.CENTER) ;
            f2 = new TextField("12 %chrd",5) ;

            l3 = new Label("Angle", Label.CENTER) ;
            f3 = new TextField("5 deg",5) ;
        ...
        class Inr extends Panel {
           Foil outerparent ;
           Label l1,l2 ;
           Button bspu,bspd,balu,bald,banu,band ;
           Button bcnu,bcnd,bthu,bthd,baru,bard ;
           ...
           Inr (Foil target) {
              ...
              l1 = new Label("DOWN", Label.CENTER) ;
              l1.setForeground(Color.blue) ;
              l2 = new Label("UP", Label.CENTER) ;
              l2.setForeground(Color.blue) ;

              bspu = new Button("spu") ;
              bspu.setBackground(Color.red) ;
              bspu.setForeground(Color.red) ;
              bspd = new Button("spd") ;
              bspd.setBackground(Color.blue) ;
              bspd.setForeground(Color.blue) ;

              balu = new Button("alu") ;
              balu.setBackground(Color.red) ;
              balu.setForeground(Color.red) ;
              bald = new Button("ald") ;
              bald.setBackground(Color.blue) ;
              bald.setForeground(Color.blue) ;

              banu = new Button("anu") ;
              banu.setBackground(Color.red) ;
              banu.setForeground(Color.red) ;
              band = new Button("and") ;
              band.setBackground(Color.blue) ;
              band.setForeground(Color.blue) ;

              bcnu = new Button("cnu") ;
              bcnu.setBackground(Color.red) ;
              bcnu.setForeground(Color.red) ;
              bcnd = new Button("cnd") ;
              bcnd.setBackground(Color.blue) ;
              bcnd.setForeground(Color.blue) ;

              bthu = new Button("thu") ;
              bthu.setBackground(Color.red) ;
              bthu.setForeground(Color.red) ;
              bthd = new Button("thd") ;
              bthd.setBackground(Color.blue) ;
              bthd.setForeground(Color.blue) ;

              baru = new Button("aru") ;
              baru.setBackground(Color.red) ;
              baru.setForeground(Color.red) ;
              bard = new Button("ard") ;
              bard.setBackground(Color.blue) ;
              bard.setForeground(Color.blue) ;
          ...
          public void handleBut(Event evt, Object arg) {
             double vinc,alinc,anginc,caminc,thkinc,areainc ;
             float fl1 ;
             ...
             if(label.equals("spu")) {  // up speed
                vfsd = vfsd + vinc ;
                if (vfsd >= vmx) vfsd = vmx ;
                fl1 = (float) vfsd ;
                inl.f4.setText(String.valueOf(filter0(fl1)) + outspd) ;
             }
             if(label.equals("spd")) {   // down speed
                vfsd = vfsd - vinc ;
                if (vfsd <= vmn) vfsd = vmn ;
                fl1 = (float) vfsd ;
                inl.f4.setText(String.valueOf(filter0(fl1)) + outspd) ;
             }

             if(label.equals("alu")) {   // up altitude
                alt = alt + alinc ;
                if (alt >= almx) alt = almx ;
                fl1 = (float) alt ;
                inl.f5.setText(String.valueOf(filter0(fl1)) + outalt) ;
             }
             if(label.equals("ald")) {   // down altitude
                alt = alt - alinc ;
                if (alt <= almn) alt = almn ;
                fl1 = (float) alt ;
                inl.f5.setText(String.valueOf(filter0(fl1)) + outalt) ;
             }

             if(label.equals("anu")) {   // up angle
                alfval = alfval + anginc ;
                if (alfval >= angmx) alfval = angmx ;
                fl1 = (float) alfval ;
                inl.f3.setText(String.valueOf(filter0(fl1)) + outdeg) ;
             }
             if(label.equals("and")) {    // down angle
                alfval = alfval - anginc ;
                if (alfval <= angmn) alfval = angmn ;
                fl1 = (float) alfval ;
                inl.f3.setText(String.valueOf(filter0(fl1)) + outdeg) ;
             }

             if(label.equals("aru")) {   // up area
                area = area + areainc ;
                if (area >= armx) area = armx ;
                fl1 = (float) area ;
                inl.f6.setText(String.valueOf(filter1(fl1)) + outare) ;
             }
             if(label.equals("ard")) {    // down area
                area = area - areainc ;
                if (area <= armn) area = armn ;
                fl1 = (float) area ;
                inl.f6.setText(String.valueOf(filter1(fl1)) + outare) ;
             }

             if(label.equals("cnu")) {   // up camber
                caminpt = caminpt + caminc ;
                if (caminpt >= camx) caminpt = camx ;
                fl1 = (float) caminpt ;
                camval  = caminpt / 25.0 ;
                inl.f1.setText(String.valueOf(filter0(fl1)) + outlng) ;
             }
             if(label.equals("cnd")) {    // down camber
                caminpt = caminpt - caminc ;
                if (caminpt <= camn) caminpt = camn ;
                fl1 = (float) caminpt ;
                camval  = caminpt / 25.0 ;
                inl.f1.setText(String.valueOf(filter0(fl1)) + outlng) ;
             }

             if(label.equals("thu")) {   // up thickness
                thkinpt = thkinpt + thkinc ;
                if (thkinpt >= thkmx) thkinpt = thkmx ;
                fl1 = (float) thkinpt ;
                thkval  = thkinpt / 25.0 ;
                inl.f2.setText(String.valueOf(filter0(fl1)) + outlng) ;
             }
             if(label.equals("thd")) {    // down thickness
                thkinpt = thkinpt - thkinc ;
                if (thkinpt <= thkmn) thkinpt = thkmn ;
                fl1 = (float) thkinpt ;
                thkval  = thkinpt / 25.0 ;
                inl.f2.setText(String.valueOf(filter0(fl1)) + outlng) ;
             }
...
//  load up performance plots
        ...
        public void paint(Graphics g) {
           ...
           if (dispp == 20) {
              ...
              off2Gg.fillRect(0,0,350,350) ;
              off2Gg.setColor(Color.white) ;
              off2Gg.drawString("Lift",120,190) ;
              off2Gg.drawString("Drag",260,190) ;

              off2Gg.drawString("Scale",15,20) ;

              off2Gg.setColor(Color.cyan) ;
              off2Gg.fillRect(10,30,60,20) ;
              off2Gg.setColor(Color.black) ;
              off2Gg.drawString("x .1",15,45) ;

              off2Gg.setColor(Color.green) ;
              off2Gg.fillRect(10,60,60,20) ;
              off2Gg.setColor(Color.black) ;
              off2Gg.drawString("x 10",15,75) ;

              off2Gg.setColor(Color.red) ;
              off2Gg.fillRect(10,90,60,20) ;
              off2Gg.setColor(Color.black) ;
              off2Gg.drawString("x 100",15,105) ;

              off2Gg.setColor(Color.magenta) ;
              off2Gg.fillRect(10,120,60,20) ;
              off2Gg.setColor(Color.black) ;
              off2Gg.drawString("x 1,000",15,135) ;

              off2Gg.setColor(Color.yellow) ;
              off2Gg.fillRect(10,150,60,20) ;
              off2Gg.setColor(Color.black) ;
              off2Gg.drawString("x 10,000",15,165) ;

              off2Gg.setColor(Color.white) ;
              off2Gg.fillRect(10,180,60,20) ;
              off2Gg.setColor(Color.black) ;
              off2Gg.drawString("x 100,000",15,195) ;
   ...
   // Lift gage
            ...
            if (liftab < 0.0) {
              ...
              for (index=0 ; index <= 10; index ++) {
                off2Gg.drawLine(100,17+index*15,140,17+index*15) ;
                off2Gg.drawString(String.valueOf(index),145,19+index*15) ;
              }
              ...
              off2Gg.fillRect(100,17,30,(int) (15*Math.abs(liftab))) ;
            }
            ...
            if (liftab >= 0.0) {
              ...
              for (index=0 ; index <= 10; index ++) {
                off2Gg.drawLine(100,17+index*15,140,17+index*15) ;
                off2Gg.drawString(String.valueOf(index),145,169 - index*15) ;
              }
              ...
              off2Gg.fillRect(100,167-(int)(15*Math.abs(liftab)),30,(int)(15*Math.abs(liftab))) ;
            }
   // Drag gage
            dragab = drag ;
              ...
              off2Gg.setColor(Color.yellow);
              for (index=0 ; index <= 10; index ++) {
                off2Gg.drawLine(250,17+index*15,290,17+index*15) ;
                off2Gg.drawString(String.valueOf(index),295,169 - index*15) ;
              }
              ...
              off2Gg.fillRect(250,167-(int)(15*Math.abs(dragab)),30,(int)(15*Math.abs(dragab))) ;
          }
